...
export const UnifiedSearch: React.FC<UnifiedSearchProps> = ({ 
  ...
  return (
    <div className="px-4 mt-2 space-y-3 relative z-40">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-white dark:bg-surface-dark border border-gray-100 dark:border-gray-800 transition-all shadow-sm outline-none text-[12px] uppercase font-bold tracking-wider focus:border-primary focus:ring-4 focus:ring-primary/10 text-gray-800 dark:text-white placeholder-gray-400"
        />

        {searchTerm && (
          <button 
            onClick={() => onSearchChange('')}
            className="absolute inset-y-0 right-0 pr-4 flex items-center transition-colors text-gray-400 hover:text-primary"
          >
        ...
        {searchTerm.length >= 2 && (
          <>
            <div className="fixed inset-0 z-[-1]" onClick={() => onSearchChange('')} />
