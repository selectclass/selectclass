...
import { ChevronLeftIcon, XIcon, CheckIcon, UsersIcon } from './Icons';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 mt-6 pt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-3 px-4 rounded-xl bg-primary text-white font-bold text-sm shadow-lg hover:bg-primary-dark transition-all"
                >
                  Cancelar
                </button>
                <button
