            ...
            <div className="flex items-center gap-2 bg-gray-100 dark:bg-white/5 p-1.5 rounded-full border border-gray-200 dark:border-gray-700/50 shadow-inner overflow-x-auto no-scrollbar">
                ...
                <div className="relative group min-w-[70px]">
                    <select 
                        ...
                        className={`w-full appearance-none bg-white dark:bg-surface-dark py-2 pl-3 pr-6 rounded-full text-[11px] font-black uppercase text-gray-700 dark:text-white focus:outline-none focus:ring-2 ${focusRing} shadow-sm cursor-pointer border border-gray-100 dark:border-gray-700`}
                    >
                ...
                <div className="relative group min-w-[90px]">
                    <select 
                        ...
                        className={`w-full appearance-none bg-white dark:bg-surface-dark py-2 pl-3 pr-8 rounded-full text-[11px] font-black uppercase text-gray-700 dark:text-white focus:outline-none focus:ring-2 ${focusRing} shadow-sm cursor-pointer border border-gray-100 dark:border-gray-700`}
                    >
                ...
                <div className="relative group">
                    <select 
                        ...
                        className={`appearance-none bg-white dark:bg-surface-dark py-2 pl-4 pr-8 rounded-full text-[11px] font-black uppercase text-gray-700 dark:text-white focus:outline-none focus:ring-2 ${focusRing} shadow-sm cursor-pointer border border-gray-100 dark:border-gray-700`}
                    >
