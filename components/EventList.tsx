...
import { TrashIcon, ShareIcon, PencilIcon, AlertCircleIcon, PlusIcon, CalendarIcon, MapPinIcon, WhatsAppIcon, ClockIcon, BoxIcon, CheckIcon, XIcon, MailIcon, ChevronUpIcon, ChevronDownIcon, DollarSignIcon, ChevronLeftIcon } from './Icons';
...
interface EventListProps {
  ...
  onChargeEvent?: (event: CalendarEvent) => void;
    ...
    <div className="px-4 py-4 pb-32">
      ...
      {!hideCount && filterMode === 'cursos' && (
        <div className="mb-4 space-y-2">
          <div className="text-[14px] font-black text-primary dark:text-primary/70 uppercase tracking-[0.2em] mb-2 text-center">
          ...
          <div className="grid grid-cols-4 gap-1 px-1">
            ...
            >
              ...
              <span className={`text-[10px] font-black uppercase tracking-tighter text-center leading-tight ${activeGroup === 'all' ? 'text-primary dark:text-primary/70' : 'text-gray-500'}`}>
                Todos
              </span>
            </button>
            ...
            >
              ...
              <span className={`text-[10px] font-black uppercase tracking-tighter text-center leading-tight ${activeGroup === 'zero' ? 'text-primary dark:text-primary/70' : 'text-gray-500'}`}>
                Sinal
              </span>
            </button>
            ...
            >
              ...
              <span className={`text-[10px] font-black uppercase tracking-tighter text-center leading-tight ${activeGroup === 'partial' ? 'text-primary dark:text-primary/70' : 'text-gray-500'}`}>
                Parcial
              </span>
            </button>
            ...
            >
              ...
              <span className={`text-[10px] font-black uppercase tracking-tighter text-center leading-tight ${activeGroup === 'paid' ? 'text-primary dark:text-primary/70' : 'text-gray-500'}`}>
                Pago
              </span>
            </button>
          </div>
          ...
          {(() => {
            ...
            if (!isDailyChecklistOpen && hasMissingMaterials) {
              ...
              headerClasses += "text-primary dark:text-primary/70";
            }

            return (
              <div className="mt-4 bg-primary/5 dark:bg-surface-dark border border-primary/10 dark:border-primary/20 rounded-xl shadow-sm mx-1 overflow-hidden transition-all duration-300">
                <h4 
                  ...
                  <div className="px-4 pb-4 animate-in fade-in slide-in-from-top-4 duration-300">
                   ...
                   <div className="flex flex-col sm:flex-row gap-2">
                     <input
                       ...
                       className="w-full sm:flex-[2] bg-white dark:bg-black/20 border border-primary/20 dark:border-primary/40 rounded-lg px-3 py-2 text-[11px] font-bold outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-sm"
                     ...
                     <input
                       type="tel"
                       placeholder="R$ 0,00"
                       className="w-full sm:flex-[1] bg-white dark:bg-black/20 border border-primary/20 dark:border-primary/40 rounded-lg px-3 py-2 text-[11px] font-bold outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-sm"
                     ...
                     <button
                       ...
                       className="w-full sm:w-auto bg-primary text-white px-4 py-2 rounded-lg text-[12px] font-black uppercase shadow hover:bg-primary-dark transition-colors"
                     >
                       Adicionar
                     </button>
                   </div>
                   ...
                   <div className="mt-1 text-center relative max-w-sm ml-auto mr-auto">
                      <button 
                        ...
                        className="w-full bg-primary text-white px-3 py-2 rounded-lg text-[12px] font-black uppercase shadow-sm hover:bg-primary-dark transition-colors flex items-center justify-center gap-1.5"
                      >
                ...
                {dailyMaterialsReport.length > 0 ? (
                  <div className="space-y-3">
                    {dailyMaterialsReport.map((m, idx) => {
                      ...
                      return (
                        <div key={idx} className="flex flex-col gap-1.5 border-b border-primary/20 dark:border-primary/20 last:border-0 pb-3 last:pb-0">
                          {materialToDelete === m.name ? (
                            ...
                            <div className="flex flex-col gap-2 p-2 bg-primary/5 dark:bg-black/10 rounded-lg border border-primary/10 dark:border-primary/40">
                              <div className="flex flex-col sm:flex-row gap-2">
                                <input
                                 type="text"
                                 className="w-full sm:flex-[2] bg-white dark:bg-black/20 border border-primary/20 dark:border-primary/40 rounded-lg px-3 py-2 text-[11px] font-bold outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-sm"
                              ...
                              <div className="flex gap-2 w-full mt-1">
                                <button onClick={() => setEditingDailyMaterialName(null)} className="flex-1 bg-gray-200 dark:bg-white/10 text-gray-600 dark:text-gray-300 px-3 py-2 rounded-lg text-[12px] font-black hover:bg-gray-300 uppercase transition-colors shadow-sm">Cancelar</button>
                                <button onClick={() => {
                                ...
                                }} className="flex-1 bg-primary text-white px-3 py-2 rounded-lg text-[12px] font-black hover:bg-primary-dark uppercase transition-colors shadow-sm">Salvar</button>
                              </div>
                            </div>
                          ) : (
                          ...
                          <div className="flex flex-col gap-0.5 mt-0.5">
                             {m.notAssignedEvents.length > 0 ? (
                               <div className="flex flex-col items-start gap-1 mt-1">
                                  ...
                                  <button onClick={() => onAddDailyMaterial && onAddDailyMaterial(m.name, m.cost, m.notAssignedEvents)} className="bg-primary text-white border border-primary-dark px-2 py-0.5 rounded text-[10px] font-black uppercase hover:bg-primary-dark transition-colors">
      ...
      <div className="space-y-4">
        {(hideCount || filterMode === 'palestras' ? events : (
          ...
          const isExpanded = isPalestra || expandedEventIds.includes(evt.id);
          ...
          return (
            ...
            >
              <div 
                onClick={() => !isPalestra && toggleEventExpansion(evt.id)}
                className={`bg-primary py-2 px-4 flex items-center justify-between transition-colors ${!isPalestra ? 'cursor-pointer active:bg-primary-dark' : ''}`}
              >
                  <div className="flex-1 min-w-0 pr-4">
                    <h3 className="text-[13px] font-black text-white leading-tight truncate uppercase tracking-tighter">
                      {evt.student || (isPalestra ? 'Evento Corporativo' : 'Aluna sem nome')}
                    </h3>
                  </div>
                  <div className="flex items-center gap-3">
                    {isNearDeadline && (
                      <div className="animate-soft-blink">
              ...
              <AnimatePresence>
                {!isExpanded && (
                  <motion.div 
                    ...
                    className="p-3 bg-gray-50/50 dark:bg-white/5 cursor-pointer border-b border-gray-100 dark:border-gray-800"
                  >
                     <div className="grid grid-cols-2 gap-3">
                        <div className="flex flex-col gap-0.5">
                           <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Já pago</span>
                           <span className="text-[11px] font-black text-emerald-600">R$ {totalPaid.toFixed(2).replace('.', ',')}</span>
                        </div>
                        <div className="flex flex-col gap-0.5 text-right relative">
                           <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Falta quitar</span>
                           <div className="flex items-center justify-end gap-2">
                              <span className={`text-[11px] font-black ${isPaid ? 'text-emerald-500' : 'text-red-500'}`}>R$ {remaining.toFixed(2).replace('.', ',')}</span>
                           </div>
                        </div>
                     </div>
                     
                     {/* PENDING DATES INFO OR INSTALLMENT CHOICE EDITOR */}
                     {!isPaid && (
                        <div className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-800">
                           {installmentChoice?.eventId === evt.id ? (
                             <div 
                               onClick={(e) => e.stopPropagation()} 
                               className="bg-white dark:bg-black/20 p-2.5 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 flex flex-col gap-2.5"
                             >
                               <div className="flex justify-between items-center">
                                 <span className="font-black text-gray-500 dark:text-gray-400 uppercase text-[10px]">Parcela {installmentChoice.installment}</span>
                                 <button 
                                   onClick={() => setInstallmentChoice(null)}
                                   className="bg-gray-100 dark:bg-white/10 text-gray-500 py-1 px-1.5 rounded-md hover:bg-gray-200 dark:hover:bg-white/20 hover:text-primary transition-colors"
                                 >
                               ...
                               <div className="flex gap-2 w-full">
                                 <button 
                                   onClick={() => {
                                     onDirectInstallmentPaid?.(evt, installmentChoice.installment);
                                     setInstallmentChoice(null);
                                   }}
                                   className="flex-1 bg-emerald-500 text-white py-2 rounded-lg font-black uppercase text-[10px] shadow hover:bg-emerald-600 transition-colors text-center"
                                 >
                                   BAIXA
                                 </button>
                                 <button 
                                   onClick={() => {
                                     onQuickInstallmentPaid?.(evt, installmentChoice.installment);
                                     setInstallmentChoice(null);
                                   }}
                                   className="flex-1 bg-primary text-white py-2 rounded-lg font-black uppercase text-[10px] shadow hover:bg-primary-dark transition-colors text-center"
                                 >
                                   LANÇAR
                                 </button>
                               </div>
                               ...
                               <div className="flex flex-col gap-1.5 border-t border-gray-100 dark:border-gray-800 pt-2.5 mt-0.5">
                                 ...
                                 <div className="flex gap-2 w-full">
                                   <input 
                                     id={`compact-date-input-${evt.id}-${installmentChoice.installment}`}
                                     type="date" 
                                     className="flex-1 bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1 text-gray-700 dark:text-gray-300 font-bold focus:ring-2 focus:ring-primary focus:outline-none transition-all text-[10px]" 
                                     defaultValue={`${scheduleDates[installmentChoice.installment-1].getFullYear()}-${String(scheduleDates[installmentChoice.installment-1].getMonth()+1).padStart(2,'0')}-${String(scheduleDates[installmentChoice.installment-1].getDate()).padStart(2,'0')}`}
                                   />
                                   <button 
                                     onClick={() => {
                                       const input = document.getElementById(`compact-date-input-${evt.id}-${installmentChoice.installment}`) as HTMLInputElement;
                                       if (input && input.value) {
                                         onChangeInstallmentDate?.(evt, installmentChoice.installment, input.value);
                                         setInstallmentChoice(null);
                                       }
                                     }}
                                     className="bg-gray-200 dark:bg-white/10 text-gray-700 dark:text-gray-200 px-3 py-1 rounded-lg text-[10px] font-black uppercase hover:bg-gray-300 transition-colors"
                                   >
                                     OK
                                   </button>
                                 </div>
                             ...
                             (isCourseDateNear || hasPendingInstallmentNear) && (
                                <div className="flex items-center justify-between w-full">
                                   <div className="flex flex-wrap gap-1.5 items-center">
                                      <span className="text-[8px] font-black text-red-500 uppercase tracking-widest">Atenção:</span>
                                      {scheduleDates.map((d, i) => {
                                         const isPaidInstallment = evt.payments?.some(p => p.installment === i + 1);
                                         if (isPaidInstallment) return null;
                                         const installmentDate = new Date(d);
                                         installmentDate.setHours(0,0,0,0);
                                         const isBlinking = (installmentDate.getTime() - today.getTime()) <= (1 * 24 * 60 * 60 * 1000);
                                         ...
                                         return (
                                           <button 
                                             ...
                                             onClick={(e) => {
                                               e.stopPropagation();
                                               setInstallmentChoice({ eventId: evt.id, installment: i + 1 });
                                             }}
                                             className="bg-red-500 text-white text-[9px] font-black px-1.5 py-0.5 rounded animate-pulse uppercase cursor-pointer hover:bg-red-600 active:scale-95 transition-all"
                                           >
                                              P{i+1}: {d.toLocaleDateString('pt-BR', {day:'2-digit', month:'2-digit'})}
                                           </button>
                                         );
                                      })}
                                      {isCourseDateNear && !isPaid && (
                                         <span className="bg-red-600 text-white text-[9px] font-black px-1.5 py-0.5 rounded animate-pulse uppercase">
                                            DIA DO CURSO!
                                         </span>
                                      )}
                                   </div>
                                   <button 
                                      ...
                                      className="bg-red-500 text-white px-2 py-1 rounded-md text-[9px] font-black uppercase hover:bg-red-600 transition-all flex items-center gap-1 shadow-sm active:scale-95"
                                   >
                                      <DollarSignIcon className="w-2.5 h-2.5" /> COBRAR
                                   </button>
                                </div>
                             )
                           )}
                  ...
                  >
                    <div className="p-2 flex flex-col items-center text-center gap-0.5">
                      <div className="mb-1">
                          ...
                          {evt.createdAt && (
                            <p className="text-[9px] text-gray-400 dark:text-gray-500 font-medium mt-0.5">
                              Criado em: {new Date(evt.createdAt).toLocaleDateString('pt-BR')} - {new Date(evt.createdAt).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                            </p>
                          )}
                      </div>
                      
                      <div className="w-full bg-gray-50 dark:bg-white/5 rounded-lg p-1.5 mb-1.5 border-y border-gray-100 dark:border-gray-800">
                      ...
                      {!isPalestra && scheduleDates.length > 0 && (
                        <div className="w-full bg-primary/5 dark:bg-primary/10 border border-primary/10 dark:border-primary/30 rounded-lg p-3 mb-2 text-left">
                            <p className="text-[10px] font-black uppercase text-primary dark:text-primary/70 mb-2 flex items-center gap-1">
                              <CalendarIcon className="w-3 h-3" /> PARCELAMENTO
                            </p>
                                  ...
                                  <div key={i} className={`text-[10px] text-gray-600 dark:text-gray-400 py-0.5 ${isEditing ? 'col-span-2 animate-in fade-in zoom-in-95 duration-200' : 'flex justify-between items-center'}`}>
                                    {isEditing ? (
                                        <div className="w-full bg-white dark:bg-black/20 p-2.5 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 flex flex-col gap-2.5 mt-1">
                                          <div className="flex justify-between items-center">
                                            <span className="font-black text-gray-500 dark:text-gray-400 uppercase text-[10px]">Parcela {i+1}</span>
                                            <button 
                                              onClick={() => setInstallmentChoice(null)}
                                              className="bg-gray-100 dark:bg-white/10 text-gray-500 py-1 px-1.5 rounded-md hover:bg-gray-200 dark:hover:bg-white/20 hover:text-primary transition-colors"
                                            >
                                          ...
                                          <div className="flex gap-2 w-full">
                                            <button 
                                              ...
                                              className="flex-1 bg-[#1A4373] text-white py-2 rounded-lg font-black uppercase text-[11px] shadow hover:bg-[#15365d] transition-colors text-center"
                                            >
                                              BAIXA
                                            </button>
                                            <button 
                                        ...
                                        <>
                                          <span className="font-bold">Parc. {i+1}:</span>
                                          {isPaidInstallment ? (
                                            ...
                                            <button 
                                              ...
                                              className={`flex items-center gap-1 px-2 py-1 rounded-lg transition-colors font-black border ${isBlinkingButton ? 'bg-red-500 text-white border-red-600 animate-soft-blink shadow-lg shadow-red-500/20' : 'bg-primary/10 text-primary dark:text-primary/70 border-primary/20 hover:bg-primary/20'}`}
                      ...
                      <div className={`w-full rounded-lg p-3 mb-2 text-left border ${isPalestra ? 'bg-sky-50 dark:bg-sky-900/10 border-sky-100 dark:border-sky-900/30' : 'bg-primary/5 dark:bg-primary/10 border-primary/10 dark:border-primary/30'}`}>
                          <div className="flex justify-between items-center mb-2">
                              <p className={`text-[11px] font-black uppercase flex items-center gap-1 ${isPalestra ? 'text-sky-500' : 'text-primary dark:text-primary/70'}`}>
                                <BoxIcon className="w-3.5 h-3.5" /> {isPalestra ? 'GASTOS' : 'MATERIAIS'}
                              </p>
                              
                              {!isPalestra && (
                                  <span className="text-[10px] font-black text-red-500">R$ {totalMaterialCost.toFixed(2).replace('.', ',')}</span>
                              )}
                          </div>
                          ...
                          {isPalestra ? (
                            <div className="mt-2 pt-2 border-t border-sky-100 dark:border-sky-900/30 flex flex-col gap-2">
                              <div className="flex gap-1 items-center">
                                <input 
                                  ...
                                  className="flex-1 text-[10px] bg-white dark:bg-bg-dark border border-sky-100 dark:border-sky-800 rounded px-2 py-2 outline-none text-gray-800 dark:text-white font-bold"
                                />
                                <input 
                                  type="text" 
                                  inputMode="numeric"
                                  ...
                                  className="w-14 text-[10px] bg-white dark:bg-bg-dark border border-sky-100 dark:border-sky-800 rounded px-1 py-2 outline-none text-gray-800 dark:text-white font-bold text-center"
                                />
                                <button 
                              ...
                              <div className="grid grid-cols-3 gap-1 pt-0.5">
                                {['Hotel', 'Passagem', 'Ônibus', 'Alimentação', 'Uber', '99'].map(shortcut => (
                                  <button
                                    ...
                                    className="w-full text-[9px] font-black px-1 py-1.5 bg-white dark:bg-bg-dark border border-sky-100 dark:border-sky-800 text-sky-500 rounded-md hover:bg-sky-50 transition-colors whitespace-nowrap"
                                  >
                                    {shortcut}
                                  </button>
                                ))}
                            ...
                            <div className="mt-2 pt-2 border-t border-primary/10 dark:border-primary/20 flex flex-col gap-2">
                                ...
                                <div className="grid grid-cols-3 gap-1 pt-0.5">
                                  {courseShortcuts.map(shortcut => (
                                    <button
                                      key={shortcut}
                                      onClick={() => setQuickMaterialName({ ...quickMaterialName, [evt.id]: shortcut })}
                                      className="w-full text-[9px] font-black px-1 py-1.5 bg-white dark:bg-bg-dark border border-primary/10 dark:border-primary/40 text-primary rounded-md hover:bg-primary/5 transition-colors whitespace-nowrap"
                                    >
                                      {shortcut}
                                    </button>
                                  ))}
                          ...
                          <div className="space-y-1.5">
                              {!(isPalestra && evt.palestraType === 'MEU') && (
                                <div className="flex justify-between items-center text-xs">
                                    <span className="text-gray-500 font-bold uppercase text-[9px]">Valor:</span>
                                ...
                                <div className="pt-1.5 border-t border-gray-100 dark:border-gray-800 space-y-1">
                                  {payments.map((p, idx) => (
                                    <div key={p.id || idx} className="flex justify-between items-center text-[10px]">
                                      <span className="text-gray-500 font-bold uppercase text-[9px]">{p.method || 'Lançado'}:</span>
                              ...
                              <div className={`flex justify-between items-center text-[10px] ${!(isPalestra && evt.palestraType === 'MEU') ? 'pt-1.5 border-t border-gray-100 dark:border-gray-800' : ''}`}>
                                  <span className="text-gray-500 font-bold uppercase text-[9px]">Gastos:</span>
                              ...
                              {!(isPalestra && evt.palestraType === 'MEU') && (
                                <>
                                  <div className="flex justify-between items-center text-[10px] pt-1.5 border-t border-gray-100 dark:border-gray-800">
                                      <span className="text-gray-500 font-bold uppercase text-[9px]">Lucro:</span>
                                  ...
                                  <div className="flex justify-between items-center text-sm pt-1.5 border-t border-dashed border-gray-200 dark:border-gray-700">
                                      <span className="font-black text-gray-800 dark:text-white uppercase text-[9px]">
                      ...
                      {isPalestra ? null : (
                        !isPaid && deadlineDisplay && !evt.paymentFrequency && (
                            <div className={`w-full bg-gray-50 dark:bg-white/5 rounded-lg p-2 mb-2 flex items-center justify-center border border-gray-100 dark:border-gray-800 overflow-hidden ${isNearDeadline ? 'animate-soft-blink' : ''}`}>
                                <span className="text-red-600 dark:text-red-500 text-[11px] font-black uppercase tracking-tighter text-center">
                                    ✓ {deadlineDisplay.startsWith('PARCELA') ? deadlineDisplay : `LIMITE: ${deadlineDisplay}`}
                                </span>
                            </div>
                        )
                      )}
                      ...
                      {!isPalestra && (
                        isPaid ? (
                            <div className={`w-full py-3 text-white rounded-xl text-[11px] font-black flex items-center justify-center gap-2 shadow-sm uppercase tracking-widest bg-emerald-500 shadow-emerald-500/10`}>
                               <CheckIcon className="w-4 h-4" /> CURSO PAGO
                            </div>
                        ) : (
                          <div className="flex flex-col gap-2 w-full pt-1">
                            <div className="grid grid-cols-3 gap-1.5">
                              <button 
                                ...
                                className="flex flex-col items-center justify-center py-2.5 rounded-xl bg-primary text-white hover:bg-primary-dark active:scale-95 transition-all shadow-sm"
                              >
                                <PlusIcon className="w-5 h-5 mb-1" />
                                <span className="text-[10px] font-black uppercase tracking-wider">Lançar</span>
                              </button>
                              <button 
                              ...
                              >
                                ...
                                <span className="text-[10px] font-black uppercase tracking-wider">Resumo</span>
                              </button>
                              <button 
                                onClick={() => onChargeEvent?.(evt)}
                                className="flex flex-col items-center justify-center py-2.5 rounded-xl bg-red-500 text-white hover:bg-red-600 active:scale-95 transition-all shadow-sm"
                              >
                                <DollarSignIcon className="w-5 h-5 mb-1" />
                                <span className="text-[10px] font-black uppercase tracking-wider">COBRAR</span>
                              </button>
                            </div>
                          </div>
                        )
                    ...
                    <div className="flex border-t border-gray-100 dark:border-gray-800 divide-x divide-gray-100 dark:divide-gray-800 bg-gray-50/50 dark:bg-white/5">
                        {isPalestra ? (
                          <a 
                            ...
                            className="flex-1 py-2.5 flex items-center justify-center text-gray-400 hover:text-sky-500 active:text-sky-600 transition-all" 
                            title="WhatsApp"
                          >
                          ...
                          <button 
                            ...
                            className="flex-1 py-2.5 flex items-center justify-center text-gray-400 hover:text-emerald-500 transition-all" 
                            title="Compartilhar"
                          >
                        ...
                        {evt.email && (
                          <button 
                            ...
                            className={`flex-1 py-2.5 flex items-center justify-center transition-all ${copiedEmailId === evt.id ? 'text-emerald-500' : 'text-gray-400 hover:text-primary'}`}
                            title="Copiar E-mail"
                          >
                            {copiedEmailId === evt.id ? <CheckIcon className="w-4 h-4" /> : <MailIcon className="w-4 h-4" />}
                          </button>
                        )}
                        <button onClick={() => onEditEvent(evt)} className={`flex-1 py-2.5 flex items-center justify-center text-gray-400 ${isPalestra ? 'hover:text-sky-500' : 'hover:text-primary'} transition-all`} title="Editar"><PencilIcon className="w-4 h-4" /></button>
                        <button onClick={() => onDeleteEvent(evt.id)} className="flex-1 py-2.5 flex items-center justify-center text-gray-400 hover:text-red-500 transition-all" title="Excluir"><TrashIcon className="w-4 h-4" /></button>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
