...
import { PlusIcon, TrashIcon, MicIcon, CheckIcon, MenuIcon, XIcon, ChevronLeftIcon } from './Icons';
...
export const LectureModelManager: React.FC<LectureModelManagerProps> = ({ models, onAdd, onRemove, onSaveOrder, onClose }) => {
