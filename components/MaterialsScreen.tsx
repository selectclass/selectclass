...
import { BoxIcon, PlusIcon, TrashIcon, XIcon, ChevronLeftIcon } from './Icons';
...
export const MaterialsScreen: React.FC<MaterialsScreenProps> = ({ courseTypes, onUpdateCourse, onClose }) => {
       ...
       <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                  {/* Icon Container */}
                  <div className="w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary dark:text-primary/70">
