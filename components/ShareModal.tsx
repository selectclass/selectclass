...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, event }) => {
  ...
  const generateMessage = () => {
    ...
    // Novo formato de mensagem conforme solicitado, com parágrafos e sem o prefixo 'curso' fixo.
    return `Parabéns pela sua aquisição! O seu ${event.title} foi agendado para o dia ${formattedDate} (${dayOfWeek}) às ${event.time}.

Endereço: Rua Francisco Antônio Miranda, N°58 - Guarulhos SP. Sala N°6, tem um interfone do lado da porta é só pressionar o n° 6!`;
  };
