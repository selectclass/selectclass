...
const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
  ...
  const icons = {
    ...
    info: <CheckCircleIcon className="w-5 h-5 text-primary" /> // Reusing check for info for simplicity or add InfoIcon
  };
  ...
  const bgColors = {
    ...
    info: 'bg-white dark:bg-surface-dark border-l-4 border-primary'
  };
