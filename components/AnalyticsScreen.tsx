    ...
    <div className="p-4 pb-32">
        <div className="flex items-center justify-between mb-6 gap-2">
            <div className="min-w-0">
                <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-1 whitespace-nowrap">Ranking de {filterType === 'palestras' ? 'Palestras' : 'Cursos'}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 truncate">Análise e desempenho.</p>
            </div>
            
            <div className="flex bg-gray-100 dark:bg-white/5 p-1 rounded-full border border-gray-200 dark:border-gray-800 shadow-inner flex-shrink-0">
                <button 
