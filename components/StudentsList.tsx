...
import { SearchIcon, WhatsAppIcon, MapPinIcon, PencilIcon, TrashIcon, XIcon, ChevronLeftIcon } from './Icons';
...
export const StudentsList: React.FC<StudentsListProps> = ({ students, onEdit, onDelete, onClose }) => {
    ...
    <div className="p-4 pb-20">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-1">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Minhas Alunas</h2>
          {onClose && (
            <button 
              onClick={onClose}
            ...
            <div key={student.id} className="bg-white dark:bg-surface-dark rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-800 flex justify-between items-center gap-4 relative">
              ...
              <div className="flex items-center gap-2 flex-shrink-0 z-20 relative">
                ...
                <button
                    ...
                    className="p-3 rounded-xl bg-gray-50 dark:bg-white/5 text-primary hover:bg-primary/5 dark:hover:bg-primary/20 transition-all active:scale-95"
                    title="Editar"
                >
