        ...
        <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
                ...
                {onClose && (
                  <button 
                    onClick={onClose}
                    className="hidden sm:flex p-2 rounded-xl bg-gray-100 dark:bg-white/5 text-gray-400 hover:text-primary hover:bg-gray-200 dark:hover:bg-white/10 transition-all active:scale-95 border border-gray-200 dark:border-gray-800 shadow-sm"
                    title="Fechar"
                  >
                    <XIcon className="w-4 h-4" />
                  </button>
