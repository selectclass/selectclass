...
import { SearchIcon, ChevronLeftIcon, CalendarIcon, MapPinIcon, ClockIcon, XIcon } from './Icons';
...
export const AllEventsList: React.FC<AllEventsListProps> = ({ events, courseTypes, lectureModels, onEventClick, onClose }) => {
    ...
    <div className="p-4 space-y-6 animate-fade-in pb-32">
      <div className="flex items-center justify-between gap-1">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Veja seus registros</p>
        </div>
        {onClose && (
          <button 
            onClick={onClose}
