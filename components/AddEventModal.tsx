                          ...
                          {paymentMethod === 'Facilitado' && (
                            <div className="pt-2 animate-fade-in">
                                ...
                                <div className="grid grid-cols-4 gap-1">
                                    <button type="button" onClick={() => setPaymentFrequency('weekly')} className={`py-2 px-1 rounded-lg text-[8px] font-black uppercase tracking-tighter truncate transition-all border ${paymentFrequency === 'weekly' ? 'bg-primary border-primary text-white shadow-md' : 'bg-gray-50 border-gray-100 text-gray-400'}`}>Semanal</button>
                                    <button type="button" onClick={() => setPaymentFrequency('biweekly')} className={`py-2 px-1 rounded-lg text-[8px] font-black uppercase tracking-tighter truncate transition-all border ${paymentFrequency === 'biweekly' ? 'bg-primary border-primary text-white shadow-md' : 'bg-gray-50 border-gray-100 text-gray-400'}`}>Quinzenal</button>
                                    <button type="button" onClick={() => setPaymentFrequency('monthly')} className={`py-2 px-1 rounded-lg text-[8px] font-black uppercase tracking-tighter truncate transition-all border ${paymentFrequency === 'monthly' ? 'bg-primary border-primary text-white shadow-md' : 'bg-gray-50 border-gray-100 text-gray-400'}`}>Mensal</button>
                                    <button type="button" onClick={() => setPaymentFrequency(undefined)} className={`py-2 px-1 rounded-lg text-[8px] font-black uppercase tracking-tighter truncate transition-all border ${paymentFrequency === undefined ? 'bg-primary border-primary text-white shadow-md' : 'bg-gray-50 border-gray-100 text-gray-400'}`}>Nenhum</button>
                                </div>
