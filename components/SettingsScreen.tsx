...
import { MoonIcon, SunIcon, UsersIcon, CheckIcon, LockIcon, ChevronLeftIcon } from './Icons';
    ...
    <div className="p-6 space-y-8 pb-32">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {onClose && (
          <button 
            onClick={onClose}
            className="p-2.5 rounded-2xl bg-gray-50 dark:bg-white/5 text-gray-400 hover:text-primary hover:bg-gray-100 dark:hover:bg-white/10 transition-all active:scale-95 border border-gray-200 dark:border-gray-800 shadow-sm"
            title="Voltar"
          >
