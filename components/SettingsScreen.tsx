  ...
  return (
    <div className="p-6 space-y-8 pb-32">
      ...
      <section className="bg-white dark:bg-surface-dark rounded-2xl shadow-sm p-6 border-l-4 border-primary">
        ...
        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Exibido no topo da Home</p>
      ...
      <section className="bg-white dark:bg-surface-dark rounded-2xl shadow-sm p-6">
        ...
        <form onSubmit={handleSaveCredentials} className="space-y-4">
            ...
            >
                ...
                {isSavedCreds ? 'CREDENCIAL SALVA NA NUVEM' : 'SALVAR NO FIREBASE'}
            </button>
        </form>
      </section>
      ...
      <div className="text-center pt-8">
        <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em]">SelectClass v1.8.5</p>
      </div>
