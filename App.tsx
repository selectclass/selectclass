          ...
          <>
            ...
            <div className="px-4 mb-2">
                <div className="bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4">
                    ...
                    <div className="flex justify-center mb-5"><div className="bg-gray-100 dark:bg-white/5 px-4 py-2 rounded-full font-black text-xs uppercase text-gray-600 dark:text-gray-300">{dashboardDate.toLocaleDateString('pt-BR', { month: 'short', year: 'numeric' })}</div></div>
